...
export function Hero() {
  ...
  return (
    ...
    >
      {/*
        Mobile: justify-between verteilt Content + Stats über die volle Höhe
        Desktop: justify-center zentriert den Content
      */}
      <motion.div
        style={{ y, opacity }}
        className="relative flex-1 flex flex-col justify-between sm:justify-center items-center text-center mx-auto max-w-7xl w-full px-5 sm:px-8 lg:px-12"
      >
        {/* Spacer oben - schiebt Content auf Mobile nach unten weg vom Navbar */}
        <div className="pt-24 sm:pt-0 sm:hidden" />
        ...
        <div className="flex flex-col items-center">
          ...
          <motion.p
            ...
            className="mt-7 sm:mt-8 text-[15px] sm:text-lg text-slate-300 max-w-md leading-relaxed"
          >
            5 Elektrotechnikermeister. Über 50 Jahre Erfahrung.
            Ihre Vision, unsere Umsetzung.
          </motion.p>

          {/* CTAs - mehr Abstand, zentriert */}
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.55, ease }}
            className="mt-7 sm:mt-8 flex flex-row gap-3 justify-center"
          >
            <a
              href="#kontakt"
          ...
          {/* Trust badge - deutlich mehr Abstand */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/[0.04] px-5 py-2.5">
              ...
              <p className="text-[13px] sm:text-sm text-white/90 font-medium">
                <strong className="text-brand font-bold">100+</strong> zufriedene Kunden
              </p>
            </div>
          </motion.div>
        </div>

        {/* Spacer unten - nur Mobile, drückt Content weg von Stats */}
        <div className="pb-4 sm:hidden" />
      </motion.div>

      {/* Stats - fest am unteren Rand, klar getrennt */}
      <div className="relative mx-auto max-w-7xl w-full px-5 sm:px-8 lg:px-12 pb-7 sm:pb-10">
        <div className="grid grid-cols-3 border-t border-white/[0.08] pt-5 sm:pt-8">
          {[
